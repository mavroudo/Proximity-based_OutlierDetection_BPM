...
/*
 * Indexing.BallTree.BallTree.java
...
/**
 <!-- globalinfo-start -->
 * Class implementing the Indexing.BallTree.BallTree/Metric Tree algorithm for nearest neighbour search.<br/>
...
public class BallTree_Weka
    ...
    /** The root node of the Indexing.BallTree.BallTree. */
    ...
    /**
     * Creates a new instance of Indexing.BallTree.BallTree.
     */
    public BallTree_Weka() {
        super();
     ...
     * @param insts The instances/points on which the Indexing.BallTree.BallTree
     * should be built on.
     */
    public BallTree_Weka(Instances insts) {
        super(insts);
        if(getMeasurePerformance())
            m_Stats = m_TreeStats = new TreePerformanceStats();
    }
    ...
    public String globalInfo() {
        return
                "Class implementing the Indexing.BallTree.BallTree/Metric Tree algorithm for "
    ...
    /**
     * Builds the Indexing.BallTree.BallTree on the supplied set of
...
//                (EuclideanDistance)m_DistanceFunction);
    ...
    public void setEuclideanDistanceFunction(EuclideanDistance func){
        this.m_TreeConstructor.setEuclideanDistanceFunction(func);
    }
     ...
     * @throws Exception If the structure of the Indexing.BallTree.BallTree is not correct,
    ...
    /**
     * Adds one instance to the Indexing.BallTree.BallTree. This involves creating/updating the
    ...
    /**
     * Builds the Indexing.BallTree.BallTree based on the given set of instances.
     * @param insts The insts for which the Indexing.BallTree.BallTree is to be
     * built.
     * @throws Exception If some error occurs while
     * building the Indexing.BallTree.BallTree
     */
    ...
    /**
     * Sets the BallTreeConstructor for building the Indexing.BallTree.BallTree
    ...
    public double getMeasure(String additionalMeasureName) {
        if (additionalMeasureName.compareToIgnoreCase("measureMaxDepth") == 0) {
            ...
            throw new IllegalArgumentException(additionalMeasureName
                    + " not supported (Indexing.BallTree.BallTree)");
        }
    }
